      ...
      >
        ...
        >
          <div className="h-full w-full rounded-md bg-slate-1100 p-2 shadow-xl">
            <button className="flex w-full items-center justify-between rounded p-2 text-sm font-medium text-indigo-400 hover:bg-indigo-600 active:bg-indigo-800 hover:text-white">
              <span>Invite People</span>
              <div className="justfiy-center flex h-4 w-4 items-center">
                <UserAddIcon />
              </div>
            </button>
            <button className="flex w-full items-center justify-between rounded p-2 text-sm font-medium hover:bg-indigo-600 active:bg-indigo-800 hover:text-white">
